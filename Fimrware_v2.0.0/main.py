...
ctk.set_appearance_mode("system")  # Pode ser "light", "dark", ou "system" (baseado no SO)
ctk.set_default_color_theme("green")  # Pode ajustar o tema de cor também, blue, dark-blue, green
...
com_port_combo.grid(row=0, column=1, padx=60)
...
baudrate_combo.grid(row=0, column=3, padx=0, pady=5)
...
connect_button.grid(row=0, column=4, padx=60, pady=10)
...
frame_entry.grid_propagate(False)
...
endline_combo.grid(row=0, column=2, padx=0, pady=10)
